...
- **Core Agents (Auto-Seeded)**: Eight core agents (the "coding swarm") are automatically created on server startup:
  ...
  - **Google Places SWOT Agent** - 5-minute "startup auditor" that turns any local business listing into a growth blueprint. Runs a 10-step diagnostic: business fingerprint, competition map, SWOT matrix, platform economics, AI/trend snapshot, content goldmine, knowledge-base JSON, 4 ready-to-deploy system prompts (Voice/SMS/Website/Owner-PA), integration cheat-sheet, and owner onboarding script (Kimi K2.5, high dominance + conscientiousness)
