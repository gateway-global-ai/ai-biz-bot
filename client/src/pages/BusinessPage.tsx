  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200">
      <nav className="sticky top-0 z-50 bg-slate-950/80 backdrop-blur-md border-b border-slate-800 px-6 py-3 flex items-center justify-center overflow-visible">
        <img src={gatewayLogo} alt="Gateway Global AI" className="h-14 w-auto opacity-90 -my-4 relative z-10 drop-shadow-lg" style={{ filter: 'drop-shadow(0 4px 12px rgba(0,0,0,0.5))' }} />
      </nav>
      {stage === 'generating' && (
