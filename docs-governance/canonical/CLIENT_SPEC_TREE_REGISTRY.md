...
| Governed views / forms | [`VIEW_REGISTRY.md`](./VIEW_REGISTRY.md), [`ACTION_REGISTRY.md`](./ACTION_REGISTRY.md), [`AI_DESIGN_STUDIO_GOVERNED_SPEC_V1.md`](./AI_DESIGN_STUDIO_GOVERNED_SPEC_V1.md) | Manual input / tour panels map here when productized; Design Studio pipeline + manifest |
