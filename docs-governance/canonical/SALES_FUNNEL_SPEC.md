...
**Positioning (homepage / public):** Marketing copy leads with **AI Front Desk** and friction removal; platform depth is secondary. Customer idle UX and intent framing: [INTENT_DRIVEN_CANVAS_SPEC.md](./INTENT_DRIVEN_CANVAS_SPEC.md).
...
```json
{
  ...
  "conversationWorkflow": "optional — see PHASED_INDUSTRY_FUNNEL_SPEC.md",
  "createdAt": "ISO timestamp",
  "updatedAt": "ISO timestamp"
}
```

**Phased workflows (industry packs):** Optional `conversationWorkflow` on each funnel object defines gated phases and context keys. See [PHASED_INDUSTRY_FUNNEL_SPEC.md](./PHASED_INDUSTRY_FUNNEL_SPEC.md).
