...
**Global deploy steps and API:** [AGENT_SWARM_DEPLOYMENT_RUNBOOK.md](./AGENT_SWARM_DEPLOYMENT_RUNBOOK.md) (`POST /api/intelligence/provision`, verification checklist).
